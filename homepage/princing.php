        ...
        <div class="bandeauteam col-12">
          <div class="row g-3 mb-5 mt-4">
            <div class="paragraphetext col-7 align-self-center">
              ...
              Tarifs <span class="ml-2"><a href="./testaccueil.php" style="font-family: 'Alkatra', serif; font-size: 45px; color: #240085; text-decoration:none;">Noma'tech</a></span>
              </h1>
              <!-- <h2 class="text-center" style="font-family: 'Alkatra', serif;">
              Vous allez adorer cette nouvelle façon de collaborer !</h2> -->
              <br>
              <h4 class="text-center" style="font-family: 'Oswald', serif;">
              Notre politique de pricing est simple et transparente. <br>
              La création d'un compte freelance et entreprise est gratuite. <br>  
              Nous prenons une commission de 4% sur chaque projet, elle est calculée sur le prix global du projet et est prelevée au moment du paiement. </h4>
</p>
            </div>
