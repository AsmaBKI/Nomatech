				...
				<div class="form-holder">
					<div class="form-content">
						<div class="form-items">
							...
							<form action="../entreprise/pageEntrepriseFormAnnonceValidation.php" method="post" class="requires-validation">
								...
								<div class="col-md-12 mt-4">
									...
									<input type="radio" class="btn-check" name="budget" value="Moins de 250€" id="low" required>
									<label class="btn btn-sm btn-outline-secondary" for="low">Moins de 250€</label>

									<input type="radio" class="btn-check" name="budget" value="Entre 250€ et 500€" id="medium" required>
									<label class="btn btn-sm btn-outline-secondary" for="medium">Entre 250€ et 500€</label>

									<input type="radio" class="btn-check" name="budget" value="Entre 500€ et 1000€" id="big" required>
									<label class="btn btn-sm btn-outline-secondary" for="big">Entre 500€ et 1000€</label>

									<input type="radio" class="btn-check" name="budget" value="+ de 1000€" id="verybig" required>
									<label class="btn btn-sm btn-outline-secondary" for="verybig">+ de 1000€</label>
