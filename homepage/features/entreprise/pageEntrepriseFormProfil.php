				...
				<div class="form-holder">
					<div class="form-content">
						<div class="form-items">
							...
							<form action="../entreprise/pageEntrepriseFormProfilValidation.php" method="POST" class="requires-validation" enctype="multipart/form-data">
								...
								<div class="col-md-12 mt-4">
									...
									<input type="text" class="form-control" name="siret" id="exampleFormControlInput1" placeholder="Entrer les 13 chiffres de votre SIRET" required pattern="[0-9]{13}">
								</div>
