...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5 ">
      ...
      <a href="pageEntrepriseFormProfil.php" class="btn btn-primary mt-5" style="font-family: 'Oswald', serif;"> Revenir à la page précédente </a>
      <a href="pageEntrepriseFormAnnonce.php" class="btn btn-primary mt-5" style="font-family: 'Oswald', serif;"> Déposer une annonce </a>
    </div>
    <br><br><br>
    <!------------------ FOOTER ------------------>
